...
<a href="login.jsp"><button class="btn btn-success"> 退&nbsp;&nbsp;出</button></a>
 ...
 <table>
 <tr>
  <form method="post" action="/WarehouseManage//inquiry.do?select=good&keyword=Gno">
  <td><input type="text" name="Gno" placeholder="请在这里输入商品号"  class="form-control" style="width: 250px ;"></td>
   <td><button type="submit"class="btn btn-success"  name="submit"  style="width:60px;">确&nbsp;&nbsp;定</button></td>
   <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </form>
  <form method="post" action="/WarehouseManage//inquiry.do?select=good&keyword=Gname" >
  <td><input type="text" name="Gname" placeholder="请在这里输入商品名称"  class="form-control" style="width: 250px ;"></td>
  <td> <button type="submit"class="btn btn-success"  name="submit"  style="width:60px;">确&nbsp;&nbsp;定</button></td>
  </form>
  </tr>
 </table>
        ...
        <c:forEach items="${goods}" var="s" varStatus="status">
            ...
            <td width="95" height="95"><img src="${s.img }" width=100% height=100% /></td>
                ...
                <td style="text-align:center; vertical-align:middle;">${s.min }</td>
                 ...
                 <td style="text-align:center; vertical-align:middle;"><a href="/WarehouseManage/AEdit.do?select=goods&id=${s.id }">编辑<span class="glyphicon glyphicon-edit"></span> </a></td>
                <td style="text-align:center; vertical-align:middle;"><a href="/WarehouseManage/Delete.do?id=${s.id}&select=goods" onclick="return Del();">删除<span class="glyphicon glyphicon-trash"></span> </a></td>
   ...
   <nav  style="margin:0 auto; width:300px ">
    <ul class="pagination">
        <li <c:if test="${!page.hasPreviouse}">class="disabled"</c:if>>
            <a href="/WarehouseManage/list.do?page.start=0&&select=goods">
                <span>«</span>
            </a>
        </li>

        <li <c:if test="${!page.hasPreviouse}">class="disabled"</c:if>>
            <a href="/WarehouseManage/list.do?page.start=${page.start-page.count}&select=goods">
                <span>‹</span>
            </a>
        </li>
        ...
        <c:forEach begin="0" end="${page.totalPage-1}" varStatus="status">
            ...
            <c:if test="${status.count*page.count-page.start<=30 && status.count*page.count-page.start>=-10}">
                <li <c:if test="${status.index*page.count==page.start}">class="disabled"</c:if>>
                    <a
                            href="/WarehouseManage/list.do?page.start=${status.index*page.count}&select=goods"
        ...
        <li <c:if test="${!page.hasNext}">class="disabled"</c:if>>
            <a href="/WarehouseManage/list.do?page.start=${page.last}&select=goods">
                <span>»</span>
            </a>
        </li>
    </ul>
